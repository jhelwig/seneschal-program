    ...
    vec![
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Search the Traveller Map for worlds, sectors, or subsectors by name. Returns matching locations with their coordinates and basic data.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "query": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Find all worlds within jump range of a specified location. Essential for planning travel routes and finding nearby destinations.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Calculate the shortest jump route between two locations. Returns a list of worlds along the optimal path.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "start": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Get detailed world data for a specific location including UWP, trade codes, bases, stellar data, and more. More comprehensive than UWP parsing.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Get all world data for a sector or subsector. Returns UWP listings for all worlds in the region.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Convert between location formats - sector/hex to world-space coordinates or vice versa.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "List all known sectors in Charted Space. Can filter by milieu/era.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "milieu": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Generate a URL for a sector or subsector map image. Returns a URL that can be used to display or embed the map.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Generate a URL for a jump range map centered on a specific world. Shows all worlds within jump range.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Download a sector or subsector map from Traveller Map and save it to FVTT assets. Returns the FVTT path for use in journal entries, scenes, etc.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
        ...
        OllamaToolDefinition {
            ...
            function: OllamaFunctionDefinition {
                ...
                description: "Download a jump range map centered on a world and save it to FVTT assets. Returns the FVTT path for use in journal entries, scenes, etc.".to_string(),
                parameters: serde_json::json!({
                    "type": "object",
                    "properties": {
                        "sector": {
